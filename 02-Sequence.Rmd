...
a) $\sum_{n=1}^\infty\left(\frac{3}{n(n+1)+ }+\frac{1}{2^n}\right)$ <!-- stewart page 717 example 9-->
b) $\sum_{n=1}^\infty\left(\frac{3}{n(n+1)+ }+\frac{1}{2^n}\right)$ <!-- stewart page 720 Question 33 example 9 answer 7/2-->
