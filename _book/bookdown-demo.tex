...
\caption{\label{tab:unnamed-chunk-8}The frequency distribution of native countries}
\centering
...
\caption{\label{tab:unnamed-chunk-10}The frequency distribution of grades for Statistics}
\centering
\begin{tabular}[t]{l|r|r}
\hline
...
\caption{\label{tab:unnamed-chunk-12}The frequency distribution of the number of family members}
\centering
\begin{tabular}[t]{l|r|r}
\hline
...
\caption{\label{tab:unnamed-chunk-14}The frequency distribution of ages of undergraduates of Batch 19}
\centering
\begin{tabular}[t]{l|r|r}
\hline
