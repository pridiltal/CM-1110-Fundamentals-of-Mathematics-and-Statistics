...
```{r box8, out.width='100%', fig.asp=.75, fig.align='center' }
...
```{r box9, out.width='100%', fig.asp=.75, fig.align='center' }

kable(s_table1)

ggplot(data=s_table1, aes(x=`Passenger class`, y=Percentage)) +
  geom_bar(stat="identity") +
  geom_text(data=s_table1, aes(label=paste(Percentage, "%")), vjust=-0.3, size=3.5) +
  ggtitle("Composition of passengers by passenger class " )+
  scale_fill_grey()
```
...
```{r box10, out.width='100%', fig.asp=.75, fig.align='center'}
...
```{r box11, out.width='100%', fig.asp=.75, fig.align='center'}
...
```{r box12, out.width='100%', fig.asp=.75, fig.align='center'}
...
```{r box13, out.width='100%', fig.asp=.75, fig.align='center' }
...
ggplot(data=s_table1, aes(x="", y=Percentage, fill = `Passenger class`)) +
  ...
  geom_text( aes(label=paste(scales::percent(Percentage/100), "%")), position = position_stack(vjust = 0.5)) +
  ggtitle("Composition of passengers by passenger class " )+
  scale_fill_grey()
...
```{r box16, out.width='100%', fig.asp=.75, fig.align='center'}
#df<-data.frame(x = NULL, y = NULL)
...
```{r hist, out.width='100%', fig.asp=.75, fig.align='center'}
set.seed(123)
...
```{r box18, out.width='100%', fig.asp=.75, fig.align='center'}
#df<-data.frame(x = NULL, y = NULL)
...
```{r hist2, out.width='100%', fig.asp=.75, fig.align='center'}
set.seed(123)
 data <- tibble(Marks = c(11,12,12,13,15,16,17,18,18, round(rnorm(11,22,1),0), round(rnorm(9,27,1),0), round(rnorm(6,32,1),0), 36,37,38,41,44))
...
```{r hist3, out.width='100%', fig.asp=.75, fig.align='center'}
set.seed(123)
 data <- tibble(Marks = c(11,12,12,13,15,16,17,18,18, round(rnorm(11,22,1),0), round(rnorm(9,27,1),0), round(rnorm(6,32,1),0), 36,37,38,41,44))
