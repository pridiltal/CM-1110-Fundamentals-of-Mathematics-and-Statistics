...
```{r box6, fig.cap='', out.width='100%', fig.asp=.75, fig.align='center'}
#df<-data.frame(x = NULL, y = NULL)
...
```{r box8, fig.cap='', out.width='100%', fig.asp=.75, fig.align='center' }

ggplot(data=s_table1, aes(x=`Passenger class`, y=Count)) +
  geom_bar(stat="identity", fill = "lightblue") +
  geom_text(data=s_table1, aes(label=Count), vjust=-0.3, size=3.5)+
  ggtitle("Composition of passengers by passenger class")

```


```{r box9, fig.cap='', out.width='100%', fig.asp=.75, fig.align='center' }



ggplot(data=s_table1, aes(x=`Passenger class`, y=Percentage)) +
  geom_bar(stat="identity", fill = "lightblue") +
  geom_text(data=s_table1, aes(label=Percentage), vjust=-0.3, size=3.5) +
  ggtitle("Composition of passengers by passenger class " )
...
count(Pclass,Survived) %>%
 ...
 # mutate(prop = n / sum(n)) %>%
  #select(-n) %>%
 datas%>% spread(Pclass, n, fill = 0)
```



```{r box10, fig.cap='', out.width='100%', fig.asp=.75, fig.align='center'}
...
```{r box11, fig.cap='', out.width='100%', fig.asp=.75, fig.align='center'}
...
count(Pclass,Survived) %>%
 ...
 mutate(prop = n / sum(n)) %>%
  ...
  #select(-n) %>%
 datas%>% spread(Pclass, prop, fill = 0)
...
```{r box12, fig.cap='', out.width='100%', fig.asp=.75, fig.align='center'}
...
```{r box13, fig.cap='', out.width='100%', fig.asp=.75, fig.align='center' }

print(s_table1)

ggplot(data=s_table1, aes(x="", y=Percentage, fill = `Passenger class`)) +
  geom_bar(width = 1, stat = "identity")+
   coord_polar("y", start=0)+
   theme(axis.text.x=element_blank())+
  geom_text(data=s_table1, aes(label=scales::percent(Percentage/100)), size = 5) +
  ggtitle("Composition of passengers by passenger class " )+
  scale_fill_grey()
...
knitr::include_graphics("figure/pictogram.png")
```

```{r box16, fig.cap='', out.width='100%', fig.asp=.75, fig.align='center'}
#df<-data.frame(x = NULL, y = NULL)
...
```{r box18, fig.cap='', out.width='100%', fig.asp=.75, fig.align='center'}
#df<-data.frame(x = NULL, y = NULL)
