...
\textbf{Example I:} A player rolls a die.

\textbf{Example II:} A player rolls two dice.

\textbf{Example III:} A quality control engineer of a certain company takes a random sample of 4 products as the products come off its production line and counts the number of defective products in the sample.

\textbf{Example IV:} A quality control engineer of a certain company takes a random sample of 4 products as products come off its production line and determines whether each product is defective or non-defective

\textbf{Example V:} A company produces a certain type of car batteries. If a battery has a voltage that is outside certain limits, that battery is characterized as bad (B); if the battery has a voltage within the prescribed limits it is characterized as good (G). A quality inspector selects batteries one by one as they come off the production line and tests them until he gets a bad battery. He uses this data to estimate the proportion of bad batteries produced by the company.

\textbf{Example VI:} An experiment consists of measuring the lifetime of a bulb.
...
\tightlist
\item
  The event that one number is even.
\item
  The event that sum of the two numbers is odd
\item
  The event that the numbers are equal
\item
  The event of getting 2 and 5
\item
  The event of getting 2 or 5
\end{enumerate}

\textbf{Example III:} Consider Example III in Activity 01,
...
\textbf{Example IV:} Consider Example IV in Activity 01
...
\textbf{Example V:} Consider Example V in Activity 01,
...
\textbf{Example VI:} Consider Example VI in Activity 01,
...
\item
  B = the event that two numbers are equal
\end{enumerate}
...
\textbf{Example 18:} In a small company there are 5 executive managers. Two of them are males and 3 are females. Three executive managers are to be selected for a committee.
