...
\caption{Relationship of mean, median and mode for different types of skewness}\label{fig:unnamed-chunk-34}
\end{figure}
...
\caption{Types of kurtosis}\label{fig:unnamed-chunk-35}
\end{figure}
