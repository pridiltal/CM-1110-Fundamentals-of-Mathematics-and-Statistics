...
\item
  Construct a frequency table
\item
  Find the absolute frequency, relative frequency and cumulative frequency of each class
\end{enumerate}
...
\tightlist
\item
  Find the quartile of the ditribution and interpret the values
\item
...
\item
  Marks for the course module AB and the corresponding lecture attendence of 10 students are given below
\end{enumerate}
...
Lecture attendence & 13 & 6 & 15 & 4 & 12 & 14 & 15 & 10 & 11 & 6\tabularnewline
\bottomrule
\end{longtable}
...
\item
  Comment on the relationship between the marks and the lecture attendence
\end{enumerate}
...
\item
  Is the ditribution symmetrical, positively skewed, or negatively skewed? Explain.
\end{enumerate}
